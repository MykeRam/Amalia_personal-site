...
export const aboutContent = {
  ...
  paragraphs: [
    ...
    "Since then, I have gained valuable flight experience and have served as a Certified Flight Instructor - Instrument at Fly AmaliAir. In this role, I develop and implement customized training syllabi designed to challenge students, strengthen decision-making, and build confidence in complex and dynamic flight environments. I have successfully trained students pursuing Private, Commercial, and Instrument ratings, and I take pride in maintaining a strong pass rate along with consistently positive student feedback.",
